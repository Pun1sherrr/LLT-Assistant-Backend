...
from app.analyzers.rule_engine import RuleEngine, RedundantAssertionRule, MissingAssertionRule
...
'''
        ...
        redundant_issues = [issue for issue in issues if issue.type == "redundant-assertion"]
...
'''
        ...
        missing_issues = [issue for issue in issues if issue.type == "missing-assertion"]
...
'''
        ...
        trivial_issues = [issue for issue in issues if issue.type == "trivial-assertion"]
...
'''
        ...
        unused_fixture_issues = [issue for issue in issues if issue.type == "unused-fixture"]
...
'''
        ...
        unused_var_issues = [issue for issue in issues if issue.type == "unused-variable"]
